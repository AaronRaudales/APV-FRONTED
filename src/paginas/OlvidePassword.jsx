    ...
    <>
      ...
      <div className='mt-20 md:mt-5 shadow-lg px-5 py-5 rounded-xl bg-white'>
          ...
          >
            ...
            <input type="submit" value="Enviar Instrucciones" className='bg-indigo-700 w-full py-3 rounded-xl text-white uppercase font-bold mt-5 hover: cursor-pointer hover:bg-indigo-900 px-10 md:w-auto'/>
          </form>
